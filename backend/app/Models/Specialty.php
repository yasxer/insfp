...
{
    protected $fillable = ['name', 'code', 'study_mode', 'description', 'duration_semesters', 'current_semester', 'duration_years', 'is_active', 'cover_image', 'brochure_path', 'brochure_name', 'program_pdf_path'];
