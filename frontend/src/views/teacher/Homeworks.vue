    ...
    <div v-if="showCreateModal" class="fixed inset-0 bg-gray-900/50 backdrop-blur-sm flex items-center justify-center p-4 z-50 animate-fade-in">
      <div class="bg-white rounded-2xl max-w-lg w-full shadow-2xl overflow-hidden flex flex-col max-h-[90vh]">
        ...
        <form id="createHomeworkForm" @submit.prevent="submitCreate" class="p-6 overflow-y-auto space-y-5">
          ...
          <div>
              <label class="block text-sm font-semibold text-gray-700 mb-1.5">Type de rendu <span class="text-red-500">*</span></label>
              <div class="flex space-x-6">
                <label class="flex items-center cursor-pointer">
                  <input type="radio" value="online" v-model="form.submission_type" class="w-4 h-4 text-blue-600 border-gray-300 focus:ring-blue-600">
                  <span class="ml-2 mt-1 px-3 py-1 bg-blue-50 text-blue-700 text-sm font-medium rounded-full cursor-pointer">En ligne</span>
                </label>
                <label class="flex items-center cursor-pointer">
                  <input type="radio" value="in_person" v-model="form.submission_type" class="w-4 h-4 text-emerald-600 border-gray-300 focus:ring-emerald-600">
                  <span class="ml-2 mt-1 px-3 py-1 bg-emerald-50 text-emerald-700 text-sm font-medium rounded-full cursor-pointer">Présentiel</span>
                </label>
              </div>
            </div>
